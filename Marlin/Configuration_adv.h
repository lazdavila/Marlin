...
// LCD Print Progress options
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_LIMIT       60     // Maximum number of sorted items (10-256). Costs 27 bytes each.
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.192   // Unit: mm compression per 1mm/s extruder speed
 ...
 */
  ...
  #define PROBE_PT_1_X 32    // Reference thumbwheel
  #define PROBE_PT_1_Y 203
  #define PROBE_PT_2_X 32    // Pitch thumbwheel
  #define PROBE_PT_2_Y 32
  #define PROBE_PT_3_X 203   // Roll thumbwheel
  #define PROBE_PT_3_Y 118
#endif
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT   5 // Can reach all the way left
  #define PROBING_MARGIN_RIGHT 25 // Limited by Probe X offset
  #define PROBING_MARGIN_FRONT  8 // Limited by Probe Y offset
  #define PROBING_MARGIN_BACK   5 // All the way front and back
#endif

#if EITHER(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL)
  // Override the mesh area if the automatic (max) area is too large
  #define MESH_MIN_X X_MIN_POS // Allow Mesh to cover entire reachable print area
  #define MESH_MIN_Y Y_MIN_POS // Allow Mesh to cover entire reachable print area
  #define MESH_MAX_X (X_BED_SIZE + X_MIN_POS) // Allow Mesh to cover entire reachable print area
  #define MESH_MAX_Y (Y_BED_SIZE + Y_MIN_POS) // Allow Mesh to cover entire reachable print area
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   135  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define E0_MICROSTEPS    16
    #define E0_RSENSE         0.15 // Was 0.11 - but wrong for Creality, source:
