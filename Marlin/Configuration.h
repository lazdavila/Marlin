...
#define STRING_CONFIG_H_AUTHOR "Laz Davila" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3V2-422"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 130.01
  #define DEFAULT_bedKi  25.39
  #define DEFAULT_bedKd 443.75
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 410.3 }  
...
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 30, 80 }  // E Was 50
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 5000 } // LIN_ADVANCE
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013 // (mm) Distance from real junction edge
                                      // Equation: JD_mm = 0.4 * Jerk^2 / Acc(print)
                                      //                 = 0.4 * (10)^2 / 3000
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.7, -6.1, -1.41 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 25  // Avoid clips on borders (and allow for X probe offset)
                           // Overridden in Configuration_adv.h
...
// The size of the printable area = measured bed - homed position 'lost' space
#define X_BED_SIZE 232 // (235 - X_MIN_POS)
#define Y_BED_SIZE 231 // (235 - Y_MIN_POS)

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 3
#define Y_MIN_POS 4
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + X_MIN_POS) + 22 // Extended max to allow the probe to reach more of the bed.
                                                // Also set PROBING_MARGIN so can reach all spots
#define Y_MAX_POS (Y_BED_SIZE + Y_MIN_POS)
#define Z_MAX_POS 237 // 250 - 13 allowance for fitted filament guide
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
